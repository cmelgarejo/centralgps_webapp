defmodule CentralGPSWebApp.Client.LoginController do
  ...
  def login(conn, params) do
    ...
    if status == :ok do
      ...
      case status do
        201 ->
              filter_keys = [ :auth_token, :activated_at, :account_type, :configuration_id, :client_id, :client_profile_image, :created_at, :dob, :emails, :entity_profile_image, :identity_document, :language_code, :name, :permissions, :profile_image, :phones, :roles, :timezone, :updated_at, :username, :xtra_info ]
