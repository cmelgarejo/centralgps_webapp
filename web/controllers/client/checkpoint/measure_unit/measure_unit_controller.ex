defmodule CentralGPSWebApp.Client.Checkpoint.MeasureUnitController do
  ...
  #private functions
  defp api_method(form \\ "") when is_bitstring(form), do: "/checkpoint/measure_unit/" <> form
  ...
  defp save_record(s, p) do
    ...
    if (String.to_atom(p.__form__) ==  :edit) do
      data = %{measure_unit_id: p.id, configuration_id: s.client_id, description: p.description}
