defmodule CentralGPSWebApp.Client.Checkpoint.FormController do
  use CentralGPSWebApp.Web, :controller
  import CentralGPS.RestClient
  import CentralGPS.Repo.Utilities

  # POST    /checkpoint/forms/create
  # GET     /checkpoint/forms/:form_id
  # PUT     /checkpoint/forms/:form_id
  # DELETE  /checkpoint/forms/:form_id
  # GET     /checkpoint/forms
  # GET     /checkpoint/forms/json
  ...
  #private functions
  defp api_method(action \\ "") when is_bitstring(action), do: "/checkpoint/form/" <> action
